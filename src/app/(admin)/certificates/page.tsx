...
const CERTS = [
  { id: 'CERT-2025-0142', name: 'Kuwait Model School',       programme: 'Eco-Schools', issued: '2025-09-01', expires: '2026-08-31', status: 'active',  Icon: School,       color: '#52B788' },
  ...
  { id: 'CERT-2025-0139', name: 'Al-Sabah Model School',     programme: 'Eco-Schools', issued: '2024-09-05', expires: '2025-09-04', status: 'expiring', Icon: School,      color: '#52B788' },
  { id: 'CERT-2025-0138', name: 'Gulf Science University',   programme: 'Eco-Campus',  issued: '2025-01-20', expires: '2026-01-19', status: 'active',  Icon: GraduationCap,color: '#52B788' },
  ...
  { id: 'CERT-2025-0136', name: 'Rumaithiya Secondary',      programme: 'LEAF',        issued: '2025-03-15', expires: '2026-03-14', status: 'active',  Icon: Leaf,         color: '#74C69D' },
  { id: 'CERT-2025-0135', name: 'Salmiya Park School',       programme: 'Eco-Schools', issued: '2025-09-01', expires: '2026-08-31', status: 'active',  Icon: School,       color: '#52B788' },
]
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35, delay: 0.05 }} className="grid grid-cols-3 gap-4">
        {[
          { label: 'Active', count: counts.active, color: '#059669', bg: '#D1FAE5', Icon: CheckCircle2 },
