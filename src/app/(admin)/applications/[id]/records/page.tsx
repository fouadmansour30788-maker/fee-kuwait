...
export default async function OperatorRecordsPage({ params }: { params: { id: string } }) {
  return (
    <div className="space-y-4">
      {/* Print isolation: only #dossier prints. */}
      ...
      <div className="no-print flex items-center justify-between">
        <Link href={`/applications/${params.id}`} className="inline-flex items-center gap-1.5 text-sm font-medium" style={{ color: '#64748B' }}>
