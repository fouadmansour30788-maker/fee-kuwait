      ...
      <FadeIn delay={0.14}>
        <div>
          ...
          <div className="space-y-3">
            {HISTORY.map(cert => (
              <div key={cert.id} className="bg-warmwhite rounded-2xl border border-[#E7E4D6] p-4 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1 mt-0.5">
                    <Calendar className="w-3 h-3" style={{ color: '#A9B6A4' }} />
                    <p className="text-xs" style={{ color: '#A9B6A4' }}>{cert.valid}</p>
                  </div>
                </div>
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  ...
                  <button className="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-[#E8ECE1] transition-colors">
                    <Share2 className="w-4 h-4" style={{ color: '#7B8266' }} />
                  </button>
                </div>
              </div>
            ))}
